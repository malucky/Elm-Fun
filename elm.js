...
Elm.FirstFactorial = Elm.FirstFactorial || {};
Elm.FirstFactorial.Solution = Elm.FirstFactorial.Solution || {};
Elm.FirstFactorial.Solution.make = function (_elm) {
   "use strict";
   _elm.FirstFactorial = _elm.FirstFactorial || {};
   _elm.FirstFactorial.Solution = _elm.FirstFactorial.Solution || {};
   if (_elm.FirstFactorial.Solution.values) return _elm.FirstFactorial.Solution.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var solve = function ($int) {    return _U.cmp($int,1) < 0 ? $int : $List.product(_U.range(1,$int));};
   return _elm.FirstFactorial.Solution.values = {_op: _op,solve: solve};
};
Elm.Main = Elm.Main || {};
Elm.Main.make = function (_elm) {
   ...
   $FirstFactorial$Solution = Elm.FirstFactorial.Solution.make(_elm),
   $Graphics$Element = Elm.Graphics.Element.make(_elm),
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $Result = Elm.Result.make(_elm),
   ...
   "FirstFactorial test suite",
   _U.list([A2($ElmTest.test,"find factorial for positive integer",A2($ElmTest.assertEqual,$FirstFactorial$Solution.solve(10),3628800))
           ,A2($ElmTest.test,"find factorial of 0 returns 0",A2($ElmTest.assertEqual,$FirstFactorial$Solution.solve(0),0))
           ,A2($ElmTest.test,"find factorial returns the input if < 0",A2($ElmTest.assertEqual,$FirstFactorial$Solution.solve(-5),-5))]));
