...
Elm.FirstReverse = Elm.FirstReverse || {};
Elm.FirstReverse.Solution = Elm.FirstReverse.Solution || {};
Elm.FirstReverse.Solution.make = function (_elm) {
   "use strict";
   _elm.FirstReverse = _elm.FirstReverse || {};
   _elm.FirstReverse.Solution = _elm.FirstReverse.Solution || {};
   if (_elm.FirstReverse.Solution.values) return _elm.FirstReverse.Solution.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
   ...
   $String = Elm.String.make(_elm);
   var _op = {};
   var solve = function (str) {    return $String.reverse(str);};
   return _elm.FirstReverse.Solution.values = {_op: _op,solve: solve};
};
Elm.Main = Elm.Main || {};
Elm.Main.make = function (_elm) {
   ...
   $FirstReverse$Solution = Elm.FirstReverse.Solution.make(_elm),
   $Graphics$Element = Elm.Graphics.Element.make(_elm),
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $Result = Elm.Result.make(_elm),
   ...
   "FirstReverse test suite",
   _U.list([A2($ElmTest.test,"reverse string",A2($ElmTest.assertEqual,$FirstReverse$Solution.solve("hello world"),"dlrow olleh"))]));
